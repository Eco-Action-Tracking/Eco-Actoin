        ...
        <div className="container mx-auto px-6 py-20 relative">
          ...
          >
            <h1 className="text-5xl font-bold mb-6">
              Recycle Your Clothes, Save Our Planet
            </h1>
            <p className="text-xl mb-8">
              We turn your old clothes into new and innovative designs
            </p>
            <motion.button
  ...
  const services = [
    {
      ...
      title: "Recycling",
      description: "We turn your old clothes into new and useful products",
    },
    {
      icon: <Shirt size={40} />,
      title: "New Design",
      description: "We redesign clothes to fit current trends",
    },
    {
      icon: <Leaf size={40} />,
      title: "Eco-Friendly",
      description:
        "We contribute to environmental preservation by reducing waste",
    },
  ];
      ...
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <p className="text-gray-700 mb-8 text-lg leading-relaxed">
            We are an innovative company aiming to recycle used clothes and
            transform them into new and useful products. Our goal is to protect
            the environment and reduce textile waste while offering stylish and
